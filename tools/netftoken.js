...
/* @lianix-meta
{
  ...
  "inputs": [
    ...
    },
    {
      ...
      "required": false,
      "placeholder": "h:p,h:p",
      "description": "daftar proxy langsung (dipisah koma)"
    },
    {
      "name": "host",
      "type": "text",
    ...
    },
    {
      ...
      "placeholder": "plan",
      "description": "premium | standard | basic (default acak bergantian)"
    },
    {
      "name": "line",
      "type": "url",
    ...
    },
    {
      ...
      "required": false,
      "placeholder": "file",
      "description": "file proxy (per baris: host:port atau http://user:pass@host:port)",
      "accept": "*/*"
    },
    {
      "name": "ua",
      "type": "text",
      "required": false,
      "default": "acak dari 16 daftar tiap request",
      "placeholder": "string",
      "description": "paksa satu User-Agent tertentu (default: acak dari 16 daftar tiap request)"
    },
    {
      "name": "count",
      "type": "number",
    ...
    },
    {
      ...
      "default": "tokens.txt",
      "placeholder": "file",
      "description": "output (default tokens.txt)"
    },
    {
      "name": "conc",
      "type": "number",
      ...
      "default": 25,
      "placeholder": "n",
      "description": "konkuransi scan proxy (default 25)"
    },
    {
      "name": "command",
      "type": "select",
...
module.exports = { tunnel, request, newSession, genToken, ProxyPool, parseProxyLine, solvePow };
